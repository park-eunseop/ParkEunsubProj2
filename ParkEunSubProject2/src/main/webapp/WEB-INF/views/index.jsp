                                    ...
                                    <div class="features_item2 text-center">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="features_item_text">
                                                <img src="<c:url value="/resources/assets/images/featured1.jpg"/>" alt="" class="img-circle" />
                                                <p class="m-top-20">Trending Design</p>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="features_item_text">
                                                <img src="<c:url value="/resources/assets/images/featured2.jpg"/>" alt="" class="img-circle" />
                                                <p class="m-top-20">Easy to Customize</p>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="features_item_text m-top-50">
                                                <img src="<c:url value="/resources/assets/images/featured3.jpg"/>" alt="" class="img-circle" />
                                                <p class="m-top-20">Responsive Design</p>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="features_item_text m-top-50">
                                                <img src="<c:url value="/resources/assets/images/featured4.jpg"/>" alt="" class="img-circle" />
